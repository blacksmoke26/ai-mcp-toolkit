...
export const EVENT_DEFINITIONS: EventDefinition[] = [
  // == CORE Events (9) ==
  {
    ...
    defaultPayload: {protocol: 'ws', version: '1.0', features: ['streaming', 'rooms', 'auth']},
    requiredFields: [],
    simulatable: true,
    icon: '🔌',
    quickAction: true,
  },
  {
    ...
    defaultPayload: {reason: 'Client initiated disconnect', code: 1000},
    requiredFields: [],
    simulatable: true,
    icon: '🔌',
    quickAction: true,
  },
  {
    ...
    defaultPayload: {code: 'WS_CONNECTION_ERROR', message: 'Connection lost unexpectedly', stack: '', context: {}},
    requiredFields: [],
    simulatable: true,
    icon: '⚠️',
    quickAction: true,
  },
  {
    ...
    defaultPayload: {timestamp: new Date().toISOString(), serverTime: ''},
    requiredFields: [],
    simulatable: true,
    icon: '📡',
    quickAction: true,
  },
  {
    ...
    defaultPayload: {serverTimestamp: new Date().toISOString(), latency: 12},
    requiredFields: [],
    simulatable: true,
    icon: '📡',
    quickAction: true,
  ...
  },
  {
    ...
    defaultPayload: {attempt: 1, maxAttempts: 10, delay: 3000, reason: 'Connection lost'},
    requiredFields: [],
    simulatable: true,
    icon: '🔄',
  },
  {
    ...
    defaultPayload: {action: 'join', room: 'general', memberCount: 1},
  ...
  },
  {
    ...
    defaultPayload: {code: 1000, reason: 'Normal closure'},
    requiredFields: [],
    simulatable: true,
    icon: '🚪',
  },
  ...
  },
  {
    ...
    defaultPayload: {name: 'search_files', arguments: {pattern: '*.ts', directory: '/src'}},
    requiredFields: ['name'],
    simulatable: true,
    icon: '🔧',
    quickAction: true,
  },
  {
    ...
    defaultPayload: {added: ['new_tool'], removed: ['old_tool'], updated: ['updated_tool']},
    requiredFields: [],
    simulatable: true,
    icon: '🔧',
  },
  {
    ...
    defaultPayload: {resources: [], total: 0},
    requiredFields: [],
    simulatable: true,
    icon: '📂',
    quickAction: true,
  },
  {
    ...
    defaultPayload: {uri: 'file:///config.json', content: '{}'},
    requiredFields: ['uri'],
    simulatable: true,
    icon: '📄',
  },
  {
    ...
    defaultPayload: {added: ['new_resource'], removed: [], updated: []},
    requiredFields: [],
    simulatable: true,
    icon: '📂',
  },
  {
    ...
    defaultPayload: {prompts: [], total: 0},
    requiredFields: [],
    simulatable: true,
    icon: '📝',
    quickAction: true,
  },
  {
    ...
    defaultPayload: {name: 'code_review', arguments: {language: 'typescript'}},
    requiredFields: ['name'],
    simulatable: true,
    icon: '📝',
  },
  {
    ...
    defaultPayload: {level: 'debug', target: 'all'},
  ...
  // == CHAT Events (12) ==
  {
    ...
    defaultPayload: {content: 'Hello, how can I help you today?', conversationId: 'conv-123', attachments: []},
  ...
  },
  {
    ...
    defaultPayload: {conversationId: 'conv-123', messageId: 'msg-1', model: 'gpt-4', provider: 'openai'},
  ...
  },
  {
    ...
    defaultPayload: {messageId: 'msg-1', content: 'Here', partial: true, delta: 'Here'},
  ...
  },
  {
    ...
    defaultPayload: {messageId: 'msg-1', error: 'Network timeout', recoverable: true},
  ...
  },
  {
    ...
    defaultPayload: {messageId: 'msg-1'},
    requiredFields: ['messageId'],
    simulatable: true,
    icon: '⏸️',
  },
  ...
  },
  {
    ...
    defaultPayload: {conversationId: 'conv-123', limit: 50, offset: 0},
    requiredFields: [],
    simulatable: true,
    icon: '📜',
    quickAction: true,
  },
  {
    ...
    defaultPayload: {limit: 20, offset: 0, sortBy: 'updated_at', sortOrder: 'desc'},
    requiredFields: [],
    simulatable: true,
    icon: '📋',
    quickAction: true,
  ...
  // == TOOL Events (4) ==
  {
    ...
    defaultPayload: {name: 'execute_command', arguments: {command: 'ls -la'}, requestId: 'req-1'},
    requiredFields: ['name'],
    simulatable: true,
    icon: '🔧',
    quickAction: true,
  ...
  },
  {
    ...
    defaultPayload: {added: [], removed: [], updated: []},
    requiredFields: [],
    simulatable: true,
    icon: '🔧',
  },
  ...
  // == PROVIDER Events (4) ==
  {
    ...
    defaultPayload: {providers: [], total: 0},
    requiredFields: [],
    simulatable: true,
    icon: '🔗',
    quickAction: true,
  ...
  },
  {
    ...
    defaultPayload: {from: 'openai', to: 'claude', reason: 'failover'},
  ...
  // == SIMULATION Events (11) ==
  {
    ...
    defaultPayload: {scenarios: [], total: 0},
    requiredFields: [],
    simulatable: true,
    icon: '🎭',
    quickAction: true,
  },
  {
    ...
    defaultPayload: {scenarioId: 'scenario-1', parameters: {iterations: 10, delay: 100}},
  ...
  },
  {
    ...
    defaultPayload: {scenarioId: 'scenario-1', currentStep: 5, totalSteps: 10, status: 'running', elapsed: 2500},
    requiredFields: [],
    simulatable: true,
    icon: '📊',
  },
  ...
  },
  {
    ...
    defaultPayload: {scenarioId: 'scenario-1'},
    requiredFields: ['scenarioId'],
    simulatable: true,
    icon: '⏸️',
  },
  ...
  },
  {
    ...
    defaultPayload: {scenarioId: 'scenario-1', reason: 'User requested abort'},
    requiredFields: ['scenarioId'],
    simulatable: true,
    icon: '⛔',
  },
  {
    ...
    defaultPayload: {scenarioId: 'scenario-1', status: 'running', progress: 50, currentStep: 5},
    requiredFields: [],
    simulatable: true,
    icon: '📊',
  },
  ...
  // == METRICS Events (4) ==
  {
    ...
    defaultPayload: {interval: 5000, metrics: ['requests', 'latency', 'memory', 'system']},
    requiredFields: [],
    simulatable: true,
    icon: '📊',
    quickAction: true,
  ...
  },
  {
    ...
    defaultPayload: {duration: 60000, metricsCollected: 12},
    requiredFields: [],
    simulatable: true,
    icon: '⏹️',
  },
  ...
  },
  {
    ...
    defaultPayload: {reason: 'Scheduled maintenance', gracePeriod: 30, timestamp: new Date().toISOString()},
    requiredFields: [],
    simulatable: true,
    icon: '🔌',
  },
  {
    ...
    defaultPayload: {uptime: 86400, formatted: '1d 0h 0m', since: '2024-01-01T00:00:00Z'},
    requiredFields: [],
    simulatable: true,
    icon: '⏱️',
  },
  {
    ...
    defaultPayload: {version: '1.0.0', build: 'abc123', commit: 'abc1234567', releaseDate: '2024-01-01'},
    requiredFields: [],
    simulatable: true,
    icon: '🏷️',
  },
  ...
  // == NOTIFICATION Events (4) ==
  {
    ...
    defaultPayload: {room: 'general', message: 'System update in progress', metadata: {priority: 'high'}},
    requiredFields: [],
    simulatable: true,
    icon: '🔔',
    quickAction: true,
  },
  {
    ...
    defaultPayload: {message: 'Server maintenance at 2am UTC', metadata: {priority: 'info'}},
    requiredFields: [],
    simulatable: true,
    icon: '📢',
    quickAction: true,
  },
  {
    ...
    defaultPayload: {room: 'general', userId: 'user-1', userName: 'Alice', memberCount: 5},
    requiredFields: [],
    simulatable: true,
    icon: '🚪',
  },
  {
    ...
    defaultPayload: {room: 'general', userId: 'user-2', userName: 'Bob', memberCount: 4},
    requiredFields: [],
    simulatable: true,
    icon: '🚪',
  },
